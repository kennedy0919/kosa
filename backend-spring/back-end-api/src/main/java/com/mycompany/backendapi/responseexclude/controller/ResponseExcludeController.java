...
import com.mycompany.backendapi.responseexclude.dto.BoardSaveResponse;
...
public class ResponseExcludeController {
	...
	public String boardSave1(@ModelAttribute BoardSaveResponse boardResponse) {
	...
	@PostMapping("/chat") 
	public AiMessageResponse message(@RequestBody UserMessageRequest userMessageRequest) {
		log.info(userMessageRequest.toString());
		AiMessageResponse aiMessageResponse = new AiMessageResponse();
		aiMessageResponse.setQuestion(userMessageRequest.getQuestion());
		aiMessageResponse.setAnswer("삼성전자의 오늘 주가는 230000");
